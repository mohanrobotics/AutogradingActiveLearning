...
# pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_com_mohler_"+str(Percent)+".pkl", "wb" ) )
...
#         f1_score_list[i].append(f1_score)
# # dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
# pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_mohler_bag_"+str(Percent)+".pkl", "wb" ) )

# pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
...
for i,query_method in enumerate(query_methods):
	...
	f1_score_list[i].append(f1_score)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_com_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_com_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
...
# # dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
# pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )

# pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
...
for i,query_method in enumerate(query_methods):
	...
	f1_score_list[i].append(f1_score)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_com_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_com_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
