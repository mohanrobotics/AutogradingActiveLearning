...
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_nn_bag_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_nn_bag_"+str(Percent)+".pkl", "wb"))
...
for i,query_method in enumerate(query_methods):
    ...
    f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_com_NN_bag_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_com_NN_bag_"+str(Percent)+".pkl", "wb" ) )
...
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_nn_tfidf_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_nn_tfidf_"+str(Percent)+".pkl", "wb" ) )
...
for i,query_method in enumerate(query_methods):
    ...
    f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/dict_accuracy_al_com_NN_tfidf_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../results/f1_score_list_al_com_NN_tfidf_"+str(Percent)+".pkl", "wb" ) )
# supervised learning
#creating inputs and labels for TFidf
Tf = TfidfVectorizer()
student_answer_count_vector = Tf.fit_transform(df['student_modified'])
