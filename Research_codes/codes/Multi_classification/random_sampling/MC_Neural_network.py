...
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_nn_bag_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_nn_bag_"+str(Percent)+".pkl", "wb"))
...
f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_com_NN_bag_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_com_NN_bag_"+str(Percent)+".pkl", "wb" ) )
...
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_nn_tfidf_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_nn_tfidf_"+str(Percent)+".pkl", "wb" ) )
...
f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_com_NN_tfidf_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_com_NN_tfidf_"+str(Percent)+".pkl", "wb" ) )
