...
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_al_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_com_mohler_"+str(Percent)+".pkl", "wb" ) )
...
for i,model in enumerate(models):
    ...
    f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_mohler_bag_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
...
f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_com_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_com_mohler_bag_"+str(Percent)+".pkl", "wb" ) )
...
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )

pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
...
f1_score_list[i].append(f1)
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../../results/random_sampling/Multi_class/dict_accuracy_random_com_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( f1_score_list, open( "../../../results/random_sampling/Multi_class/f1_score_list_random_com_mohler_tfidf_"+str(Percent)+".pkl", "wb" ) )
