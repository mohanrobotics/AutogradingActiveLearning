...
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( dict_f1score_sl_min, open( "../../results/binary/dict_f1score_min_mohler.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_max, open( "../../results/binary/dict_f1score_max_mohler.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_avg, open( "../../results/binary/dict_f1score_avg_mohler.pkl", "wb" ) )

pkl.dump( dict_kappa_sl_min, open( "../../results/binary/dict_kappa_min_mohler.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_max, open( "../../results/binary/dict_kappa_max_mohler.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_avg, open( "../../results/binary/dict_kappa_avg_mohler.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/binary/dict_accuracy_al_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_mohler_bag.pkl", "wb" ) )
...
pkl.dump( dict_f1score_sl_min, open( "../../results/binary/dict_f1score_min_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_max, open( "../../results/binary/dict_f1score_max_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_avg, open( "../../results/binary/dict_f1score_avg_mohler_bag.pkl", "wb" ) )

pkl.dump( dict_kappa_sl_min, open( "../../results/binary/dict_kappa_min_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_max, open( "../../results/binary/dict_kappa_max_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_avg, open( "../../results/binary/dict_kappa_avg_mohler_bag.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/binary/dict_accuracy_al_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_mohler_tfidf.pkl", "wb" ) )
# supervised learning
...
pkl.dump( dict_f1score_sl_min, open( "../../results/binary/dict_f1score_min_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_max, open( "../../results/binary/dict_f1score_max_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_sl_avg, open( "../../results/binary/dict_f1score_avg_mohler_tfidf.pkl", "wb" ) )

pkl.dump( dict_kappa_sl_min, open( "../../results/binary/dict_kappa_min_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_max, open( "../../results/binary/dict_kappa_max_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_sl_avg, open( "../../results/binary/dict_kappa_avg_mohler_tfidf.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/binary/dict_accuracy_al_com_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_com_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_com_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/binary/dict_accuracy_al_com_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_com_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_com_mohler_bag.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/binary/dict_accuracy_al_com_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/binary/dict_f1score_al_com_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/binary/dict_kappa_al_com_mohler_tfidf.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_com_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_com_mohler_"+str(Percent)+".pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_com_mohler_"+str(Percent)+".pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_mohler_bag.pkl", "wb" ) )
...
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_com_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_com_mohler_bag.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_com_mohler_bag.pkl", "wb" ) )
...
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_mohler_tfidf.pkl", "wb" ) )
...
# dict_accuracy_al.to_pickle("../../results/dict_accuracy_al_mohler_"+str(Percent))
pkl.dump( dict_accuracy_al, open( "../../results/random_sampling/Binary_class/dict_accuracy_random_com_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_f1score_al, open( "../../results/random_sampling/Binary_class/dict_f1score_random_com_mohler_tfidf.pkl", "wb" ) )
pkl.dump( dict_kappa_al, open( "../../results/random_sampling/Binary_class/dict_kappa_random_com_mohler_tfidf.pkl", "wb" ) )
